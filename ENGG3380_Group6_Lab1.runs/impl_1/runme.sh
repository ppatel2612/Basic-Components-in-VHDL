...
HD_PWD='T:/Xilinx/ISE/ENGG3380_Group6_Lab1/ENGG3380_Group6_Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Bit_AND.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Four_Bit_AND.tcl -notrace

...
HD_PWD='T:/Xilinx/ISE/ENGG3380_Group6_Lab1/ENGG3380_Group6_Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Bit_AND.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Four_Bit_AND.tcl
